...
export function ShiftCard({ shift, onEdit, onDelete }: ShiftCardProps) {
  ...
  return (
    <div className="mx-3 mb-3 bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800 group relative overflow-hidden">
      <div className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-0 sm:justify-between mb-6">
          <div className="flex items-start sm:items-center">
            <svg
              className="w-5 h-5 mr-2 text-gray-500 dark:text-gray-400 mt-1 sm:mt-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{formatDate(shift.date)}</h3>
              <div className="mt-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Hours</h4>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">Base (100%):</span>
                <span className="font-medium text-gray-700 dark:text-gray-300">{shift.calculatedHours.base}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">Overtime (125%):</span>
                <span className="font-medium text-gray-700 dark:text-gray-300">
                  {shift.calculatedHours.overtime125}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">Overtime (150%):</span>
                <span className="font-medium text-gray-700 dark:text-gray-300">
              ...
              <div className="flex justify-between text-sm pt-2 border-t border-gray-100 dark:border-gray-800">
                ...
                <span className="font-medium text-gray-700 dark:text-gray-300">{shift.calculatedHours.total}</span>
              </div>
            </div>
          </div>

          <div>
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Earnings</h4>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">125%:</span>
                <span className="font-medium text-gray-700 dark:text-gray-300 tabular-nums">
